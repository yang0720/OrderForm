...
import com.qingmaiding.orderform.middleman.adapter.WithDepAdapter;
...
public class WithDepActivity extends BaseActivity {

    @BindView(R.id.recycleview)
    RecyclerView recyclerView;
    private ArrayList<JSONObject> list;
    private WithDepAdapter adapter;
...
//        this.requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.activity_withdep);
...
//        setToolbar("我的邀请");
    ...
    private void initRecycler() {
        list = new ArrayList<>();
        adapter = new WithDepAdapter(list,this) {
            @Override
