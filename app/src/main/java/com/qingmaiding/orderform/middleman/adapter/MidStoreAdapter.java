...
public abstract class MidStoreAdapter extends RecyclerView.Adapter<MidStoreAdapter.ViewHolder>{
    ...
    public MidStoreAdapter(List <JSONObject> goodsList, Context context){
        mActiveList = goodsList;
        mContext = context;
    }
    @NonNull
    @Override
    public MidStoreAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.midstore_item,parent,false);
        ViewHolder holder = new ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull MidStoreAdapter.ViewHolder holder, int position) {
        try {
