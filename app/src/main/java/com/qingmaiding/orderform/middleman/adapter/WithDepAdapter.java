...
public abstract class WithDepAdapter extends RecyclerView.Adapter<WithDepAdapter.ViewHolder>{
    ...
    public WithDepAdapter(List <JSONObject> goodsList, Context context){
        mActiveList = goodsList;
        mContext = context;
    }
    @NonNull
    @Override
    public WithDepAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.withdep_item,parent,false);
        ViewHolder holder = new ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull WithDepAdapter.ViewHolder holder, int position) {
        try {
