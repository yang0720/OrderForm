...
public abstract class PlatOrderAdapter extends RecyclerView.Adapter<PlatOrderAdapter.ViewHolder>{
    ...
    public PlatOrderAdapter(List <JSONObject> goodsList, Context context){
        mActiveList = goodsList;
        mContext = context;
    }
    @NonNull
    @Override
    public PlatOrderAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PlatOrderAdapter.ViewHolder holder, int position) {
        try {
