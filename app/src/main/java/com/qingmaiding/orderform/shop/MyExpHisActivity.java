...
import com.qingmaiding.orderform.shop.adapter.ExpHisAdapter;
...
public class MyExpHisActivity extends BaseActivity {

    @BindView(R.id.recycleview)
    RecyclerView recyclerView;
    private ArrayList<JSONObject> list;
    private ExpHisAdapter adapter;
...
//        setToolbar("我的邀请");
    ...
    private void initRecycler() {
        list = new ArrayList<>();
        adapter = new ExpHisAdapter(list,this) {
            @Override
