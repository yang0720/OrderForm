...
public abstract class ConsHisAdapter extends RecyclerView.Adapter<ConsHisAdapter.ViewHolder>{
    ...
    public ConsHisAdapter(List <JSONObject> goodsList, Context context){
        mActiveList = goodsList;
        mContext = context;
    }
    @NonNull
    @Override
    public ConsHisAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.conshis_item,parent,false);
        ViewHolder holder = new ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull ConsHisAdapter.ViewHolder holder, int position) {
        try {
